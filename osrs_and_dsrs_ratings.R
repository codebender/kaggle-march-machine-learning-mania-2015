...
matches$calculated <- 0.50 + (matches$lowIdOSRS - matches$highIdOSRS)*0.01825 + (matches$lowIdDSRS - matches$highIdDSRS)*0.024
...
write.csv(submit, file = "Output/osrs_and_dsrs_ratings_7.csv", row.names = FALSE, quote=FALSE)
