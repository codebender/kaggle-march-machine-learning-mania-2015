...
matches$calculated <- 0.50 + (matches$lowIdOSRS - matches$highIdOSRS)*0.018 + (matches$lowIdDSRS - matches$highIdDSRS)*0.023
...
write.csv(submit, file = "Output/osrs_and_dsrs_ratings_3.csv", row.names = FALSE, quote=FALSE)
